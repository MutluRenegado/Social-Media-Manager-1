...
export const saveDataToFirestore = async (collectionName: string, documentId: string, data: any): Promise<void> => {
  try {
...
export const updateDataInFirestore = async (collectionName: string, documentId: string, data: any): Promise<void> => {
  try {
...
export const addDataToFirestore = async (collectionName: string, data: any): Promise<void> => {
  try {
